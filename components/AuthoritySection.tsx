    ...
    <section id="autorita" className="autorita">
      <div className="container">
        <div className="section-head center reveal">
          ...
          <p>
            Non sei dentro una classe generica. Il lavoro è 1:1: sarete solo tu e Noemi, con spazio per analizzare il tuo profilo, la tua storia e il modo migliore per trasformarli in un progetto reale.
          </p>
        </div>
